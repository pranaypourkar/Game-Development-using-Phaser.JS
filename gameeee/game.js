...
create() {
    gameState.scoreText = this.add.text(450, 100, 'Your Score: 0', { fontSize: '36px', fill: '#000000' });
...
create() {
    ...
    gameState.player = this.physics.add.sprite(7500, 500, 'player').setScale(0.6); //10,500
