...
create() {
    gameState.scoreText = this.add.text(120, 250, 'Your Score: 0', { fontSize: '30px', fill: '#000000' });
    gameState.scoreText.setText(`Score:       ${gameState.score}`);
    this.add.text(20, 350, 'Thanks For Playing :)', { fontSize: '36px', fill: '#000000' });
    this.add.text(80, 450, 'Click to Play Again', { fontSize: '30px', fill: '#000000' });
...
preload() {
  ...
  this.load.spritesheet('bat', 'bat.png',{ frameWidth: 192, frameHeight: 192});
  this.load.spritesheet('dog', 'dog.png',{ frameWidth: 120, frameHeight: 74});  
  this.load.spritesheet('worm', 'worm.png',{ frameWidth: 64, frameHeight: 32});
  this.load.image('burst', 'charac/burst.png');
